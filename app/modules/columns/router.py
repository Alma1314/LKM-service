...
@respond
def apply_column(info: ColumnApplicationCreate, db: Session = Depends(get_session)):
...
@respond
def publish_column_post(column_id: int, info: ColumnPostCreate, db: Session = Depends(get_session)):
